...
if ($_FILES['imagen']['size'] > 0) {
    ...
    $query = "UPDATE productos SET nombre = '$nombre', precio = '$precio', descripcion = '$descripcion', descuento = '$descuento', imagen = '$imagen' WHERE id = '$id'";
} else {
    // Si no se ha subido una imagen, omitirla en la actualización
    $query = "UPDATE productos SET nombre = '$nombre', precio = '$precio', descripcion = '$descripcion', descuento = '$descuento' WHERE id = '$id'";
}
